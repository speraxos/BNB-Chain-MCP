 ...
 */
export function registerCustodialTools(server) {
    // =====================================================================
    // GET /sapi/v1/custodian/balance - Get Custodial Account Balance
    // =====================================================================
    server.tool("binance_us_cust_balance", `Get balance information for Binance.US exchange wallet and custodial sub-account.
...
- lastUpdatedTime: Last update timestamp`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_supported_assets", `Get list of assets supported for custodial solution transfers and settlements.
...
- network: Supported blockchain networks`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_wallet_transfer", `Transfer assets from Binance.US exchange wallet to custodial sub-account.
...
- createTime: Transfer creation timestamp`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_transfer", `Transfer assets from custodial partner account to Binance.US custodial sub-account.
...
- createTime: Transfer creation timestamp`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_undo_transfer", `Undo a previous transfer from your custodial partner.
...
- amount: Amount being returned`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_wallet_transfer_history", `Get history of transfers from Binance.US exchange wallet to custodial sub-account.
...
status, createTime, updateTime`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_transfer_history", `Get history of transfers from custodial partner to Binance.US custodial sub-account.
...
expressTrade flag, createTime, updateTime`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_available_balance", `Get available balance in the custodial sub-account for trading.
...
Returns the balance available for placing new orders.`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_new_order", `Place a new trade order through the custodial solution.
...
executedQty, and expressTradeFlag`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_oco_order", `Place a new OCO (One-Cancels-the-Other) order through the custodial solution.
...
Response includes orderListId, orders array, and orderReports with details.`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_open_orders", `Get all open custodial trade orders.
...
expressTradeFlag`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_get_order", `Get details of a specific custodial trade order.
...
icebergQty, time, updateTime, isWorking, expressTradeFlag`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_order_history", `Get historical custodial trade orders.
...
executedQty, and expressTradeFlag.`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_trade_history", `Get historical custodial trades (filled orders).
...
isBuyer, isMaker, isBestMatch, orderId, commission, commissionAsset`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_cancel_order", `Cancel an active custodial trade order.
...
Response includes the canceled order details with status: CANCELED`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_cancel_orders_symbol", `Cancel all active custodial orders for a specific trading pair.
...
Response is an array of all canceled orders.`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_cancel_oco", `Cancel an entire OCO (One-Cancels-the-Other) order list.
...
canceled order details.`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_settlement_settings", `Get current settlement settings for custodial solution.
...
- nextTriggerTime: Timestamp of next scheduled settlement`, {
    ...
    // =====================================================================
    server.tool("binance_us_cust_settlement_history", `Get historical settlement records for custodial solution.
