...
export function registerStakingTools(server) {
    ...
    // =====================================================================
    server.tool("binance_us_staking_asset_info", `Get staking information for supported assets on Binance.US.
...
If no asset is specified, returns information for all staking assets.`, {
    ...
    // =====================================================================
    server.tool("binance_us_staking_stake", `Stake a supported asset on Binance.US to earn staking rewards.
...
- purchaseRecordId: Record ID for the staking transaction`, {
    ...
    // =====================================================================
    server.tool("binance_us_staking_unstake", `Unstake a previously staked asset on Binance.US.
...
- result: SUCCESS or failure status`, {
    ...
    // =====================================================================
    server.tool("binance_us_staking_balance", `Get current staking balance for assets on Binance.US.
...
If no asset is specified, returns balances for all staked assets.`, {
    ...
    // =====================================================================
    server.tool("binance_us_staking_history", `Get staking transaction history for assets on Binance.US.
...
If no asset is specified, returns history for all assets.`, {
    ...
    // =====================================================================
    server.tool("binance_us_staking_rewards", `Get staking rewards history for assets on Binance.US.
