...
export function registerCreditLineTools(server) {
    ...
    // =====================================================================
    server.tool("binance_us_cl_account", `Get current credit line account information including LTV ratios, balances, and loan details.
...
Available to Withdraw: ${response.availableAmountToTransferOut}`;
    ...
    // =====================================================================
    server.tool("binance_us_cl_alert_history", `Get margin call and liquidation alert history for your credit line account.
...
when margin calls or liquidation warnings have occurred.`, {
        ...
        try {
            const requestParams = {};
            if (params.alertType)
                requestParams.alertType = params.alertType;
            if (params.startTime)
    ...
    // =====================================================================
    server.tool("binance_us_cl_transfer_history", `Get transfer history for your credit line account.
...
Use this to track deposits and withdrawals from your credit line account.`, {
        ...
        try {
            ...
            if (params.asset)
                requestParams.asset = params.asset.toUpperCase();
            if (params.startTime)
                requestParams.startTime = params.startTime;
            if (params.endTime)
                requestParams.endTime = params.endTime;
            ...
            if (Array.isArray(response) && response.length > 0) {
                response.forEach((transfer, index) => {
    ...
    // =====================================================================
    server.tool("binance_us_cl_transfer", `Transfer assets in or out of your credit line account.
