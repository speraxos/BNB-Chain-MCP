...
export function registerSubaccountTools(server) {
    ...
    // =====================================================
    server.tool("binance_us_subaccount_list", "Get a list of all sub-accounts. Filter by email or status (enabled/disabled).", {
    ...
    // =====================================================
    server.tool("binance_us_subaccount_transfer_history", "Get transfer history between master and sub-accounts.", {
    ...
    // =====================================================
    server.tool("binance_us_subaccount_transfer", "Execute an asset transfer between master account and a sub-account. ⚠️ This moves funds between accounts!", {
    ...
    // =====================================================
    server.tool("binance_us_subaccount_assets", "Get asset balances for a specific sub-account.", {
        ...
        try {
            ...
            const nonZeroBalances = data.balances?.filter((b) => parseFloat(String(b.free)) > 0 || parseFloat(String(b.locked)) > 0) || [];
            return {
                content: [{
                        type: "text",
    ...
    // =====================================================
    server.tool("binance_us_subaccount_summary", "Get the total USD value of assets in the master account and all sub-accounts.", {
    ...
    // =====================================================
    server.tool("binance_us_subaccount_status", "Get status list of sub-accounts including activation status and enabled features.", {
