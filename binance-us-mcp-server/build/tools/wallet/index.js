...
export function registerWalletTools(server) {
    ...
    // =====================================================
    server.tool("binance_us_asset_config", "Get details of all crypto assets including fees, withdrawal limits, and network status. Shows deposit/withdrawal enabled status per network.", {
    ...
    // =====================================================
    server.tool("binance_us_withdraw_crypto", "Submit a crypto withdrawal request. Requires withdrawal permission on API key. ⚠️ This action transfers funds OUT of your account - verify address carefully!", {
    ...
    // =====================================================
    server.tool("binance_us_withdraw_fiat", "Submit a USD withdrawal request via BITGO. ⚠️ This action transfers USD OUT of your account!", {
    ...
    // =====================================================
    server.tool("binance_us_withdraw_history", "Get crypto withdrawal history. Filter by coin, status, or time range.", {
    ...
    // =====================================================
    server.tool("binance_us_deposit_history", "Get crypto deposit history. Filter by coin, status, or time range.", {
        coin: z.string().optional().describe("Filter by coin symbol"),
    ...
    // =====================================================
    server.tool("binance_us_deposit_address", "Get a deposit address for a specific crypto asset. Use this to receive funds into your Binance.US account.", {
