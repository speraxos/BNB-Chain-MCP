 ...
 */
export function registerOtcTools(server) {
    // =====================================================================
    // GET /sapi/v1/otc/coinPairs - Get Supported OTC Coin Pairs
    // =====================================================================
    server.tool("binance_us_otc_coin_pairs", `Get a list of supported OTC (Over-The-Counter) trading pairs on Binance.US.
...
Example: Convert large amounts of BTC to USDT without affecting market price.`, {
    ...
    // =====================================================================
    server.tool("binance_us_otc_quote", `Request a quote for an OTC (Over-The-Counter) trade on Binance.US.
...
- toAmount/fromAmount: Calculated amounts for the trade`, {
    ...
    // =====================================================================
    server.tool("binance_us_otc_place_order", `Place an OTC (Over-The-Counter) trade order using a previously acquired quote.
...
- orderStatus: Current status of the order`, {
    ...
    // =====================================================================
    server.tool("binance_us_otc_get_order", `Get detailed information about a specific OTC (Over-The-Counter) trade order.
...
- createTime: Order creation timestamp`, {
    ...
    // =====================================================================
    server.tool("binance_us_otc_all_orders", `Query all OTC (Over-The-Counter) trade orders with optional filters.
...
toCoin, toAmount, ratio, inverseRatio, createTime`, {
    ...
    // =====================================================================
    server.tool("binance_us_ocbs_orders", `Query all OCBS (One-Click-Buy-Sell) fiat orders on Binance.US.
