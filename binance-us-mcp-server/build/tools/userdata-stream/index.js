 ...
 */
export function registerUserDataStreamTools(server) {
    // =====================================================================
    // POST /api/v3/userDataStream - Create Listen Key
    // =====================================================================
    server.tool("binance_us_create_listen_key", `Create a new listen key for User Data Stream WebSocket connection.
...
This endpoint requires API key but does NOT require signature.`, {}, async () => {
        try {
...
Response: ${JSON.stringify(response, null, 2)}`
    ...
    // =====================================================================
    server.tool("binance_us_keepalive_listen_key", `Extend the validity of a listen key by 60 minutes.
...
Remember to call this again in 30 minutes to maintain the connection.`
    ...
    // =====================================================================
    server.tool("binance_us_close_listen_key", `Close a User Data Stream by invalidating the listen key.
...
To receive real-time updates again, create a new listen key.`
    ...
    // =====================================================================
    server.tool("binance_us_websocket_info", `Get information about available WebSocket streams on Binance.US.

Returns details about:
- Market data streams (public)
- User data streams (requires listen key)
- Connection URLs and limits`, {}, async () => {
        const info = {
