 ...
 */
export function registerCreditLineTools(server) {
    // =====================================================================
    // GET /sapi/v2/cl/account - Get Credit Line Account Information
    // =====================================================================
    server.tool("binance_us_cl_account", `Get comprehensive credit line account information.
...
Full Response: ${JSON.stringify(response, null, 2)}`
    ...
    // =====================================================================
    server.tool("binance_us_cl_alert_history", `Get margin call and liquidation alert history for credit line account.
...
- Audit margin call history`, {
        ...
        try {
            ...
            const marginCalls = alerts.filter((a) => a.alertType === "MARGIN_CALL").length;
            const liquidationCalls = alerts.filter((a) => a.alertType === "LIQUIDATION_CALL").length;
            return {
                content: [{
                        type: "text",
...
Full Response: ${JSON.stringify(response, null, 2)}`
    ...
    // =====================================================================
    server.tool("binance_us_cl_transfer_history", `Get transfer history for credit line account.
...
- Reconcile account activity`, {
        ...
        try {
            ...
            const transfersIn = transfers.filter((t) => t.transferType === "TRANSFER_IN").length;
            const transfersOut = transfers.filter((t) => t.transferType === "TRANSFER_OUT").length;
            return {
                content: [{
                        type: "text",
...
Full Response: ${JSON.stringify(response, null, 2)}`
    ...
    // =====================================================================
    server.tool("binance_us_cl_transfer", `Execute a transfer in or out of the credit line account.
...
Full Response: ${JSON.stringify(response, null, 2)}`
    ...
    // =====================================================================
    server.tool("binance_us_cl_liquidation_history", `Get liquidation history for credit line account.
